...
public class CompoundInterest {
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        int years = numYears(targetYear);
        double amount = futureValue(presentValue, rate, targetYear);
        double inflated = 1 - (inflationRate/100);
        while (years > 0) {
            amount *= inflated;
            years -= 1;
        }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        int years = numYears(targetYear);
        double inf = 1 - (inflationRate / 100);
        double amount = totalSavings(perYear, targetYear, rate);
        while (years > 0) {
            amount *= inf;
            years -= 1;
        }
    ...
    static void printDollarFV(int targetYear, double returnRate,
                              double inflationRate) {
        double nominalDollarValue = futureValue(1, returnRate, 2062);
        double realDollarValue = futureValueReal(1, returnRate, 2062, inflationRate);
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double nominalSavings = totalSavings(10000, 2062, returnRate);
        double realSavings = totalSavingsReal(10000, 2062, returnRate, inflationRate);
