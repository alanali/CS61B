...
public class Tester {
    ...
    public static void isEvenTest() {
        ...
        assertTrue(Solutions.isEven(1000), "IsEvenTest");
        assertTrue(Solutions.isEven(918), "IsEvenTest");
        assertFalse(Solutions.isEven(1001), "IsEvenTest");
        assertFalse(Solutions.isEven(1), "IsEvenTest");
    }
    ...
    public static void maxTest() {
        ...
        assertIntEquals(234, Solutions.max(new int[] { 233, 5, 7, 234, 234 }), "maxTest");
        assertIntEquals(0, Solutions.max(new int[] { 0, -2, -6, -10 }), "maxTest");
        assertIntEquals(100, Solutions.max(new int[] { 100, 100, 100, 100 }), "maxTest");
    }
    ...
    public static void wordBankTest() {
        ...
        String[] nouns = new String[]{"doggo", "cat", "bunny", "book"};
        assertTrue(Solutions.wordBank("doggo", nouns), "wordBankTest");
        assertFalse(Solutions.wordBank("hamburger", nouns), "wordBankTest");
    }
//
    public static void threeSumTest() {
        ...
        assertTrue(Solutions.threeSum(new int[] { 1, -1, 0 }), "3SUM Test");
        assertTrue(Solutions.threeSum(new int[] { 5, -2, 0, 6, 7, 9 }), "3SUM Test");
        assertFalse(Solutions.threeSum(new int[] {1, 4, 3, -10}), "3SUM Test");
    }
