...
class Rotor {
    ...
    void setRings(char cposn) {
        setRings(alphabet().toInt(cposn));
    }

    /** Set ring setting to POSN.  */
    void setRings(int posn) {
        _ringSetting = posn;
    }
    ...
    int convertForward(int p) {
        ...
        perm = _permutation.permute(perm);
        int result = _permutation.wrap(perm - _setting + _ringSetting);
        if (Main.verbose()) {
